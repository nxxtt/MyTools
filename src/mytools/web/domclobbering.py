...
_WINDOW_CLOBBERABLE: frozenset[str] = frozenset({
...
_NAMED_ACCESS_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
...
_FORM_CHILD_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
...
_IMPACT_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
