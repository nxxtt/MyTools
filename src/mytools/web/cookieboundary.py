...
def _test_domain_attributes(
    ...
    for cookie in cookies:
        if not cookie.domain:
            results.append(
                CookieBoundaryAttempt(
                    technique="domain_absent",
                    category="domain",
                    cookie_name=cookie.name,
                    attribute_tested="Domain",
                    attribute_value="ausente",
                    vulnerable=True,
        ...
        if cookie.domain == "." or cookie.domain == ".*":
            results.append(
                CookieBoundaryAttempt(
                    technique="domain_wildcard",
                    category="domain",
                    cookie_name=cookie.name,
                    attribute_tested="Domain",
                    attribute_value=cookie.domain,
                    vulnerable=True,
            ...
            results.append(
                CookieBoundaryAttempt(
                    technique="domain_public_suffix",
                    category="domain",
                    cookie_name=cookie.name,
                    attribute_tested="Domain",
                    attribute_value=cookie.domain,
...
def _test_path_attributes(
    ...
    for cookie in cookies:
        if not cookie.path:
            results.append(
                CookieBoundaryAttempt(
                    technique="path_absent",
                    category="path",
                    cookie_name=cookie.name,
                    attribute_tested="Path",
                    attribute_value="ausente",
                    vulnerable=True,
            ...
            results.append(
                CookieBoundaryAttempt(
                    technique="path_overly_broad",
                    category="path",
                    cookie_name=cookie.name,
                    attribute_tested="Path",
                    attribute_value=cookie.path,
                    vulnerable=True,
    ...
    for cookie in scoped:
            ...
            try:
                ...
                results.append(
                    CookieBoundaryAttempt(
                        ...
                        error="",
                        exploit="cookie_theft_payload" if leaked else "",
                        tool="curl",
                    )
                )
        ...
        if upper_path != cookie_path:
            ...
            try:
                ...
                results.append(
                    CookieBoundaryAttempt(
                        technique="traversal_case_variation",
                        category="path_traversal",
                        cookie_name=cookie.name,
                        attribute_tested="Path",
                        attribute_value=cookie.path,
        ...
        try:
            ...
            results.append(
                CookieBoundaryAttempt(
                    technique="traversal_trailing_slash",
                    category="path_traversal",
                    cookie_name=cookie.name,
                    attribute_tested="Path",
                    attribute_value=cookie.path,
        ...
        try:
            ...
            results.append(
                CookieBoundaryAttempt(
                    technique="traversal_prefix_match",
                    category="path_traversal",
                    cookie_name=cookie.name,
                    attribute_tested="Path",
                    attribute_value=cookie.path,
...
async def _test_double_submit(
    ...
    for cookie in csrf_cookies:
        results.append(
            CookieBoundaryAttempt(
                technique="ds_cookie_no_httponly",
        ...
        results.append(
            CookieBoundaryAttempt(
                technique="ds_cookie_no_samesite",
                category="double_submit",
                cookie_name=cookie.name,
                attribute_tested="SameSite",
                attribute_value=cookie.samesite or "ausente",
        ...
        results.append(
            CookieBoundaryAttempt(
                technique="ds_cookie_overly_broad_domain",
                category="double_submit",
                cookie_name=cookie.name,
                attribute_tested="Domain",
    ...
    try:
        ...
        results.append(
            CookieBoundaryAttempt(
                technique="ds_token_in_cookie_vs_field",
                category="double_submit",
                cookie_name=csrf_cookies[0].name,
...
async def _test_samesite_dns_bypass(
    ...
    lax_cookies = [c for c in cookies if c.samesite.lower() == "lax" or not c.samesite]
    ...
    try:
        ...
        results.append(
            CookieBoundaryAttempt(
                technique="samesite_dns_bypass_risk",
                category="samesite_dns",
                cookie_name=lax_cookies[0].name,
                attribute_tested="DNS",
                attribute_value="error",
                vulnerable=False,
                details="",
                error=str(e)[:100],
    ...
    if has_low_ttl:
        results.append(
            CookieBoundaryAttempt(
                technique="dns_rebindable_ttl",
                category="samesite_dns",
                cookie_name=lax_cookies[0].name,
                attribute_tested="DNS TTL",
                attribute_value="low",
                vulnerable=True,
    ...
    if has_wildcard:
        results.append(
            CookieBoundaryAttempt(
                technique="dns_rebindable_wildcard",
                category="samesite_dns",
                cookie_name=lax_cookies[0].name,
                attribute_tested="DNS Wildcard",
                attribute_value="detected",
                vulnerable=True,
    ...
    if has_ip_flip:
        results.append(
            CookieBoundaryAttempt(
                technique="dns_rebindable_ip_flip",
                category="samesite_dns",
                cookie_name=lax_cookies[0].name,
                attribute_tested="DNS IP Flip",
                attribute_value="detected",
                vulnerable=True,
...
async def _test_csrf_subdomain(
    ...
    for cookie in csrf_cookies:
        if cookie.domain:
            ...
            if is_wildcard:
                results.append(
                    CookieBoundaryAttempt(
                        technique="csrf_subdomain_wildcard_domain",
                        category="csrf_subdomain",
                        cookie_name=cookie.name,
                        attribute_tested="Domain",
                        attribute_value=cookie.domain,
                        vulnerable=True,
                ...
                results.append(
                    CookieBoundaryAttempt(
                        technique="csrf_subdomain_cookie_scope",
                        category="csrf_subdomain",
                        cookie_name=cookie.name,
                        attribute_tested="Domain",
                        attribute_value=cookie.domain,
        ...
        if not cookie.httponly:
            results.append(
                CookieBoundaryAttempt(
                    technique="csrf_subdomain_no_httponly",
                    category="csrf_subdomain",
                    cookie_name=cookie.name,
                    attribute_tested="HttpOnly",
                    attribute_value="ausente",
        ...
        if cookie.samesite.lower() == "none":
            results.append(
                CookieBoundaryAttempt(
                    technique="csrf_subdomain_samesite_none",
                    category="csrf_subdomain",
                    cookie_name=cookie.name,
                    attribute_tested="SameSite",
    ...
    try:
        ...
        results.append(
            CookieBoundaryAttempt(
                technique="csrf_subdomain_takeover_risk",
                category="csrf_subdomain",
                cookie_name=csrf_cookies[0].name,
                attribute_tested="Subdomains",
                attribute_value="error",
                vulnerable=False,
                details="",
                error=str(e)[:100],
    ...
    if own_subdomains:
        ...
        results.append(
            CookieBoundaryAttempt(
                ...
                cookie_name=csrf_cookies[0].name,
                attribute_tested="Subdomains",
                attribute_value=f"{len(own_subdomains)} found",
                vulnerable=True,
    ...
    if risk_count >= 2:
        ...
        results.append(
            CookieBoundaryAttempt(
                technique="csrf_subdomain_combined_risk",
                category="csrf_subdomain",
                cookie_name=csrf_cookies[0].name,
                attribute_tested="Combined Risk",
...
def _test_cookie_quoting(cookies: list[CookieInfo]) -> list[CookieBoundaryAttempt]:
    ...
    for cookie in cookies:
        ...
        if ";" in value:
            results.append(
                CookieBoundaryAttempt(
                    technique="quoting_semicolon_in_value",
                    category="cookie_quoting",
                    cookie_name=cookie.name,
                    attribute_tested="Value",
                    attribute_value=value[:50],
                    vulnerable=True,
        ...
        if "\\" in raw:
            results.append(
                CookieBoundaryAttempt(
                    technique="quoting_backslash_escape",
                    category="cookie_quoting",
                    cookie_name=cookie.name,
                    attribute_tested="Raw",
                    attribute_value=raw[:50],
                    vulnerable=True,
        ...
        if "\x00" in value:
            results.append(
                CookieBoundaryAttempt(
                    technique="quoting_null_byte",
                    category="cookie_quoting",
                    cookie_name=cookie.name,
                    attribute_tested="Value",
                    attribute_value="contains \\x00",
                    vulnerable=True,
        ...
        if "," in raw and ";" not in raw.split("=", 1)[-1] if "=" in raw else True:
            ...
            if "," in rest and ";" not in rest:
                results.append(
                    CookieBoundaryAttempt(
                        technique="quoting_comma_separator",
                        category="cookie_quoting",
                        cookie_name=cookie.name,
                        attribute_tested="Separator",
                        attribute_value=",",
                        vulnerable=True,
        ...
        if quote_count % 2 != 0:
            results.append(
                CookieBoundaryAttempt(
                    technique="quoting_unbalanced_quotes",
                    category="cookie_quoting",
                    cookie_name=cookie.name,
                    attribute_tested="Quotes",
                    attribute_value=f"{quote_count} quotes",
                    vulnerable=True,
        ...
        if value != value.strip() and value.strip():
            results.append(
                CookieBoundaryAttempt(
                    technique="quoting_whitespace_in_value",
                    category="cookie_quoting",
                    cookie_name=cookie.name,
                    attribute_tested="Value",
                    attribute_value=value[:50],
