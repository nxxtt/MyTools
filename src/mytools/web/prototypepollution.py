...
_CATEGORY_MAP_DEFAULT: dict[str, list[str]] = {
    ...
    "dom": ["dom_url_param", "dom_hash", "dom_json_parse", "dom_referrer", "dom_window_name",
            "dom_merge", "dom_array", "dom_nested", "dom_bracket", "dom_cookie"],
    "library": ["jquery_extend", "lodash_merge", "vue_reactive", "angular_scope",
                "node_require", "node_fs", "node_process", "node_eval"],
}
