...
_INJECTION_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "style_tag_inject",
...
_DATA_EXTRACTION_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "background_url",
...
_ATTRIBUTE_LEAK_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "attr_src_leak",
...
_SELECTOR_ABUSE_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "nth_child_selector",
...
_TOKEN_EXFIL_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "csrf_token_leak",
...
_CSP_BYPASS_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "import_unicode_bypass",
