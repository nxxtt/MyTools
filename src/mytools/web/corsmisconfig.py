...
Testa se o servidor e vulneravel a misconfiguration CORS via:
  - Null Origin — Origin: null aceito indevidamente
  - Subdomain — qualquer subdominio aceito
  - Credentials — Access-Control-Allow-Credentials com wildcard
  - Reflected — Origin refletido diretamente no ACAO
  - Bypass — prefix/suffix/regex tricks para contornar filtros
