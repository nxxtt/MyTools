...
_MEDIA_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "video_source_onerror",
...
_URI_JS_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "a_href_js",
...
_URI_DATA_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "iframe_data_html",
...
_IFRAME_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "srcdoc_basic",
...
_BASE_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "base_href_js",
        '<base href="javascript:alert(1)//">',
        "base_js",
...
_CUSTOM_ELEMENT_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "custom_element_script",
...
_SHADOW_DOM_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "shadow_open_innerhtml",
...
_SLOT_USE_PAYLOADS: list[tuple[str, str, str, list[str]]] = [
    (
        "slot_element",
