...
tests/                          # Testes unitários (5550 testes)
...
uv run pytest tests/ --cov=mytools --cov-report=term-missing  # Com cobertura
```

### Lint
```bash
uv run ruff check src/mytools/ tests/
uv run basedpyright src/mytools/
```
